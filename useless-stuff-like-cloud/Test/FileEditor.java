...
public class FileEditor{
    ...
    private static final String studentHEADER = "studentID,studentName,studentSchool,studentGender,studentNationality, studentEmail";
    ...
    private static final int studentEmailIndex = 5;
    ...
    public static void writeStudents(Student student){
        ...
        try {
            ...
            Writer.append(COMMA);
            Writer.append(student.getStudentEmail());
            Writer.append(NEW_LINE);
        } catch (Exception e) {

...
public class Student{
    ...
    private ArrayList<Index> registeredIndices = new ArrayList<Index>(0);
    ...
    public void addIndex(Index index1){
        registeredIndices.add(index1);
    }

    public void dropIndex(Index index1){
        registeredIndices.drop(index1);
    }

    public void showRegisteredIndices(){
        for (Index index : Re)
    }
